...
class SonarInterface:
    ...
    def __init__(self, port, baudrate, fallback_emulated=True, connection_type='serial', udp_address='0.0.0.0', udp_port=12345):
    ...
    def configureAngles(self, aperture_deg, step_deg, ensure_divisor):
        ...
        if ensure_divisor:
            ...
            def computeCost(step, half_aperture): return 1000 if half_aperture % step != 0 else abs(
                step - target_step) + abs(half_aperture - target_half_aperture)
